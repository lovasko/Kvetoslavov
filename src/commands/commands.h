 ...
 * @return 0
 */
int command_continue(char **argv);
 ...
 * @return 0
 */
int command_list_files(char **argv);
 ...
 * @return 0
 */
int command_list_breaks(char **argv);
 ...
 * @return 0
 */
int command_list_functions(char **argv);
 ...
 * @return 0
 */
int command_add_break(char **argv);
 ...
 * @return 0
 */
int command_remove_break(char **argv);
